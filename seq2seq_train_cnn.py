"""
Revised by Jia, the code almost same with seq2seq.py except for importing different model.

"""

import os
from cnnS2S_Model import get_model
...
tra_provider = ChunkS2S_Slider(filename=training_path,
